  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <MetaTags>
          <title>Alerts | Dashonic - React Admin & Dashboard Template</title>
        </MetaTags>
        <Container fluid>
          {/* Render Breadcrumbs */}
            ...
            <Col xl={4}>
              <Card>
                <CardHeader className="justify-content-between d-flex align-items-center">
                  ...
                  <Link to="//reactstrap.github.io/components/alerts" target="_blank" rel="noreferrer" className="btn btn-sm btn-soft-secondary">Docs <i className="mdi mdi-arrow-right align-middle"></i></Link>
                </CardHeader>
                ...
                <CardBody>
                  <div className="">
                    ...
                    <Alert color="dark" className="mb-0">A simple dark alert—check it out!</Alert>
                  </div>
                </CardBody>
              </Card>
            </Col>
                ...
                <CardBody>
                  <div className="">
                    ...
                    <UncontrolledAlert role="alert" color="purple">
                      <i className="uil uil-bag me-2"></i>
                    ...
                    <UncontrolledAlert role="alert" color="dark" className="mb-0">
                      <i className="uil uil-location-arrow-alt me-2"></i>
            ...
            <Col xl={4}>
              <Card>
                ...
                <CardBody>
                  ...
                  <Alert color="purple">
                    A simple purple alert with <Link to="#" className="alert-link">an example link</Link>. Give it a click if you like.
                  </Alert>
                  <Alert color="danger">
              ...
              <Card>
                ...
                <CardBody>
                  <div className="">
                    ...
                    <UncontrolledAlert color="purple" className="alert-top-border">
                    ...
                    <UncontrolledAlert color="light" className="alert-top-border">
                      <i className="uil uil-moon font-size-16 me-2"></i>
