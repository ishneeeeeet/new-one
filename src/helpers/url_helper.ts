...
//KANBANBOARDS
export const GET_KANBANBOARDS = "/kanban-board";
...
export const VENDRORS = "/vendors";

export const WAREHOUSES = "/warehouses"

export const PRODUCTS = "/products";

export const INVENTORY_ADJUSTMENT = "/inventory-adjustments"

export const CATEGORIES = "/categories";

export const UNITS = "/units";

export const PRODUCT_GROUP = "/groups";

export const PURCHASE_ORDER ="/purchase-orders"

export const PURCHASE_ORDER_PRODUCT = "/po-products";

export const SHIPMENT_RECEIVED = "/goods-receiveds"

export const LEADS = "/leads"

export const INVOICES = "/invoices"

export const INVOICE_PRODUCTS = "/invoice-products";

export const CUSTOMERS = "/customers";

export const LEAD_CONVERSION ="/lead-conversions"

export const CONTRACTORS = "/contractors";

export const LEAD_CONVERSION_PRODUCTS = "/lead-conversion-products";

export const SALES_RETURNS = "/sales-returns";
